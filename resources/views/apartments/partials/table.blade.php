<div class="table-responsive">
    <form method="GET" action="{{ route('apartments.index') }}" id="searchForm">
        <table class="table table-bordered table-hover">
            ...
            <tr class="table-light">
                ...
                <th class="text-center">
                    @if(request()->hasAny(['internal_number', 'title', 'address', 'city', 'rooms', 'size_from', 'size_to', 'rent_cold_from', 'rent_cold_to', 'rent_warm_from', 'rent_warm_to', 'status']))
